<?php
// source: C:\wamp\www\NettePhpProject1\app/config/config.neon 
// source: C:\wamp\www\NettePhpProject1\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\wamp\\www\\NettePhpProject1\\app',
			'wwwDir' => 'C:\\wamp\\www\\NettePhpProject1\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\wamp\\www\\NettePhpProject1\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\wamp\\www\\NettePhpProject1\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\wamp\\www\\NettePhpProject1\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\wamp\\www\\NettePhpProject1\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\wamp\\www\\NettePhpProject1\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\wamp\\www\\NettePhpProject1\\app/../temp/cache', $this->getService('nette.cacheJournal'));
